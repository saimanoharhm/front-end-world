...
// // Booleans
// const plane = 'Airbus A32Bneo';
// console.log(plane.includes('A32B'));
...
// console.log(new String('SaiManohar'));
// console.log(typeof new String('sai'));
